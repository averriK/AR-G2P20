...
gem_root  <- "../oq/output/gem"
root <- here::here()          

source(file.path(root, "psha/R/setup.R"))
source(file.path(root, "psha/R/utils.R"))
source(file.path(root, "psha/R/global.R"))

params <- yaml::read_yaml(file.path(root, "_quarto.yml"))$params
REBUILD_UHS <- FALSE
REBUILD_Ts <- FALSE
REBUILD_Dn <- FALSE
REBUILD_kmax <- FALSE
source(file.path(root,"DATA.R"))
source(file.path(root,"psha/R/rebuild_data.R"))
source(file.path(root,"psha/R/load_data.R"))
UHSTable[ID=="sdLnSaFC1",ID:="gem2020(NL)"]
UHSTable[ID=="gem",ID:="gem2020(L)"]
